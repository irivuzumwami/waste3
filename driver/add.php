...
<head>
    ...
    <title>Add Driver - EcoWaste Admin</title>
    ...
    <div class="container">
        ...
        <form method="POST" id="registerForm" onsubmit="return validateForm()">
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" id="email" value="<?php echo isset($_POST['email']) ? htmlspecialchars($_POST['email']) : ''; ?>" placeholder="driver@ecowaste.rw" required>
            </div>
